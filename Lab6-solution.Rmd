...
1.  What are the dimensions of the Denny's dataset?  1,643 rows and 6 columns
...
What are the variables? address , city , state , zip , longitude , latitude
...
2.  What are the dimensions of the La Quinta's dataset? 909 rows and 6 columns.
    What does each row in the dataset represent? Each row represents location information about laquinta's hotel.
    What are the variables?  address , city , state , zip , longitude , latitude.
